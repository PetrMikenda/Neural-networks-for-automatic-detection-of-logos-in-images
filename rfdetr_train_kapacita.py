...
# python rfdetr_train_kapacita.py \
#   --seed 42 \
#   --dataset datasets/qmul/data.yaml \
#   --project Kapacita_qmul \
#   --models rfdetr_large
...
# ==============================================================================
parser = argparse.ArgumentParser(description="Trénovací skript pro RF-DETR (Kapacita).")
...
parser.add_argument('--models', nargs='+', default=['rfdetr_small', 'rfdetr_large'], help='Seznam modelů')
...
# Fixní rozlišení pro experiment zkoumající kapacitu
RESOLUTION = 640
EPOCHS = 100
...
# 4. HLAVNÍ SMYČKA
# ==============================================================================
print(f"START: {len(args.models)} modelů RF-DETR | Fixní rozlišení: {RESOLUTION}px")

for model_name in args.models:
    if model_name not in model_mapping:
        print(f"Model {model_name} neexistuje, přeskakuji."); continue
        
    ModelClass = model_mapping[model_name]
    run_name = f"{model_name}_img{RESOLUTION}_seed{args.seed}"
